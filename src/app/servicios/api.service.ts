...
verTurnosFinalizados(emailIngresado: string): Observable<any>{
  var recuperarTurnosFinalizados = this.http.post<Turno[]>(this.apiUrl + 'buscarTurnosFinalizadosPaciente', {email: emailIngresado});
  return recuperarTurnosFinalizados;
}
...
turnoAceptarCancelar(paciente: string, especialidad: string, dia: string, horario: string, profesional: string, accion: number, resena: string): Observable<any>{
  return this.http.post(this.apiUrl + 'turnoAceptarCancelar', {paciente: paciente, especialidad: especialidad, dia: dia, horario: horario, profesional: profesional, accion: accion, resena: resena});
}

calificarProfesional(turno: Turno, calificacion: number): Observable<any>{
